...
Built first for [Hermes Agent](https://github.com/NousResearch/hermes) cron/digest outputs, for people who **self-host their own agent**: you run a small **companion service** on your own VPS, the app talks to it directly on a pull/timeline-refresh cycle, and your content never leaves your server.
...
- [`docs/hermex-takeaways.md`](docs/hermex-takeaways.md) — lessons from Hermex's self-hosted iOS control-plane app that Crowly should borrow for onboarding, diagnostics, contract smoke tests, CI, and public-readiness — while explicitly avoiding control-plane scope creep.
